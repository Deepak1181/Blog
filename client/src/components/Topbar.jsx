...
const Topbar = () => {
  return (
    <div className='flex  items-center justify-evenly border-black   h-16 fixed w-full z-20 bg-white  border-b'>
        <div >
...
//                 <div className={`md:relative md:block absolute bg-white left-0 w-full md:top-0 top-16 md:p-0 p-5 `}>
//                     {/* <SearchBox /> */}
//                     Search box
//                 </div>
//             </div>
